 ...
 * @author jruiz
 */
public class WkGroupAggrEditor extends javax.swing.JPanel implements CidsBeanRenderer, EditorSaveListener, CidsBeanDropListener {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(WkGroupAggrEditor.class, "WkGroupAggrEditor.jLabel1.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        btnRemWkGroup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cids/custom/objecteditors/wrrl_db_mv/edit_remove_mini.png"))); // NOI18N
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${cidsBean.wk_groups}");
        org.jdesktop.swingbinding.JListBinding jListBinding = org.jdesktop.swingbinding.SwingBindings.createJListBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, eLProperty, lstWkGroups);
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(WkGroupAggrEditor.class, "WkGroupAggrEditor.jLabel2.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    private void btnRemWkGroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemWkGroupActionPerformed
    ...
    public void beansDropped(ArrayList<CidsBean> beans) {
        for (CidsBean bean : beans) {
            Collection<CidsBean> wkGruppen = (Collection<CidsBean>) cidsBean.getProperty("wk_groups");
            try {
