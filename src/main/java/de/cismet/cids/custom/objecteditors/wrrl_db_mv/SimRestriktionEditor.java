...
import de.cismet.cids.custom.wrrl_db_mv.util.RestriktionRWBand;
import de.cismet.cids.custom.wrrl_db_mv.util.RestriktionRWBandMember;
 ...
 */
public class SimRestriktionEditor extends JPanel implements CidsBeanRenderer,
    FooterComponentProvider,
    EditorSaveListener {

    //~ Static fields/initializers ---------------------------------------------

    public static final String COLLECTION_PROPERTY = "restriktionsabschnitte";

// RequestsFullSizeComponent,

    private static final String SIM_RESTRIKTION = "sim_restriktionsabschnitt";
     ...
     */
    public SimRestriktionEditor(final boolean readOnly) {
        this.readOnly = readOnly;
        jband = new JBand(readOnly);
        initComponents();

        restriktionEditor = new SimRestriktionsabschnittEditor(readOnly);
        restriktionBand.setReadOnly(readOnly);
        sbm.addBand(restriktionBand);
        ...
        switchToForm("empty");
        lblHeading.setText("Restriktion");
        panUnterhaltungshinweis.add(restriktionEditor, BorderLayout.CENTER);
    ...
    public void setCidsBean(final CidsBean cidsBean) {
        ...
        if (cidsBean != null) {
            ...
            isNew = cidsBean.getProperty("ausdehnung") == null;

            if (cidsBean.getProperty("ausdehnung") == null) {
                panBand.removeAll();
    ...
    private void setNamesAndBands() {
        ...
        restriktionBand.setRoute(route);
    ...
    private void initComponents() {
        ...
        jbApply.setText(org.openide.util.NbBundle.getMessage(SimRestriktionEditor.class, "GupGewaesserabschnitt")); // NOI18N
        ...
        jbApply1.setText(org.openide.util.NbBundle.getMessage(SimRestriktionEditor.class, "GupGewaesserabschnitt")); // NOI18N
        ...
        jLabel6.setBounds(12, 40, 92, 22);

        lblSubTitle1.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        lblSubTitle1.setText("Warnow KM 0 - 4711");
        panHeaderInfo.add(lblSubTitle1);
        lblSubTitle1.setBounds(110, 40, 350, 22);
    ...
    class RestriktionBandModelListener implements BandModelListener {
        ...
        public void bandModelSelectionChanged(final BandModelEvent e) {
            ...
            if (bm != null) {
                ...
                if (bm instanceof RestriktionRWBandMember) {
