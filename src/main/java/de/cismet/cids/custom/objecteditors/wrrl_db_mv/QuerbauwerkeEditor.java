            ...
            if ((mosWkFg != null) && (mosWkFg.length > 0)) {
                ...
                if (stat09 != null) {
                    queryWkSg = "SELECT "
                                ...
                                + "            (case when station_von.wert < station_bis.wert then station_von.wert else station_bis.wert end ) / st_length(geom_route.geo_field), "
                                + "            (case when station_von.wert < station_bis.wert then station_bis.wert else station_von.wert end ) / st_length(geom_route.geo_field) "
                                + "         ) AS geom "
                                + "      FROM "
