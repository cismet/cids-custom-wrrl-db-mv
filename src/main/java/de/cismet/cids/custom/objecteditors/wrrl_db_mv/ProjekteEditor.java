...
//            }
    ...
    private void initComponents() {
        ...
        jlMassnahmenCataloge.setCellRenderer(new MeasureTypeCodeListCellRenderer());
        ...
        jlMassnahmenAllCataloge.setCellRenderer(new MeasureTypeCodeListCellRenderer());
     ...
     * @version  $Revision$, $Date$
     */
    private class MeasureTypeCodeListCellRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(final JList list,
            ...
            final Object valObject = ((CidsBean)value).getProperty("value");
            final String val = ((valObject != null) ? valObject.toString() : "");

            lab.setText(val + " - " + value.toString());
     ...
     * @version  $Revision$, $Date$
     */
    private class StringIntValueComparator implements Comparator<CidsBean> {
