 ...
 * @author jruiz
 */
public class WkKgEditor extends javax.swing.JPanel implements CidsBeanRenderer, EditorSaveListener, FooterComponentProvider {
    ...
    private void initComponents() {
        ...
        lblSpacingBottom.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingBottom.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lblSpacingRight.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingRight.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        panAllgemeines.add(lblSpacingRight, gridBagConstraints);

        tpMain.addTab(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.panAllgemeines.TabConstraints.tabTitle"), panAllgemeines); // NOI18N
        ...
        lblSpacingBottom2.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingBottom2.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        lblSpacingRight2.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingRight2.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        tpMain.addTab(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.panRisikoabschätzung.TabConstraints.tabTitle"), panRisikoabschätzung); // NOI18N

        panQualitaetsinformationen.setOpaque(false);
        panQualitaetsinformationen.setLayout(new java.awt.GridBagLayout());

        lblSpacingBottom1.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingBottom1.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lblSpacingRight1.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingRight1.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        panQualitaetsinformationen.add(lblSpacingRight1, gridBagConstraints);

        tpMain.addTab(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.panQualitaetsinformationen.TabConstraints.tabTitle"), panQualitaetsinformationen); // NOI18N
        ...
        lblSpacingBottom3.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingBottom3.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        lblSpacingRight3.setText(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.lblSpacingRight3.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        panWeitereInformationen.add(lblSpacingRight3, gridBagConstraints);

        tpMain.addTab(org.openide.util.NbBundle.getMessage(WkKgEditor.class, "WkKgEditor.panWeitereInformationen.TabConstraints.tabTitle"), panWeitereInformationen); // NOI18N
    ...
    public void setCidsBean(final CidsBean cidsBean) {
        ...
        if (cidsBean != null) {
            ...
            cidsBean.addPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void propertyChange(PropertyChangeEvent pce) {
                    if (pce.getPropertyName().equals("ty_cd_cw")) {
                        try {
                            cidsBean.setProperty("ty_na_cw", (String) ((CidsBean) cidsBean.getProperty("ty_cd_cw")).getProperty("name"));
                        } catch (Exception ex) {
                ...
                public void propertyChange(PropertyChangeEvent pce) {
                    if (
                        ...
                        try {
                            ...
                            String[] props = {"nitrat", "eqs_hm", "eqs_pestic", "eqs_indpol", "eqs_othpl", "eqs_onatpl" };
            ...
            cidsBean.addPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void propertyChange(PropertyChangeEvent pce) {
                    if (
                            pce.getPropertyName().equals("risk_ecpo") ||
                            pce.getPropertyName().equals("risk_ecst")) {
                        try {
                            int worstCaseValue = 0;
                            String[] props = {"risk_ecpo", "risk_ecst" };
                            int worstCasePropIndex = 0;
                            for (int propIndex = 0; propIndex < props.length; propIndex++) {
                                String prop = props[propIndex];
                                String baseValue = (String) ((CidsBean) cidsBean.getProperty(prop)).getProperty("value");
                            ...
                            cidsBean.setProperty("risk_total", (CidsBean) cidsBean.getProperty(props[worstCasePropIndex]));
                        } catch (Exception ex) {
                            if (LOG.isDebugEnabled()) {
