/***************************************************//GEN-FIRST:event_rbPriorityHighValueItemStateChanged
...
public class SetHintDialog extends javax.swing.JDialog {
     ...
     */
    private void rbPriorityLowValueItemStateChanged(final java.awt.event.ItemEvent evt) {                                                    
        checkNotNull();
    }                                                   
     ...
     * @param  evt  The ItemEvent object.
     */
    private void rbPriorityNormalValueItemStateChanged(final java.awt.event.ItemEvent evt) {                                                       
        checkNotNull();
    }                                                      
     ...
     * @param  evt  The ItemEvent object.
     */
    private void rbPriorityHighValueItemStateChanged(final java.awt.event.ItemEvent evt) {                                                     
        checkNotNull();
    }                                                    
