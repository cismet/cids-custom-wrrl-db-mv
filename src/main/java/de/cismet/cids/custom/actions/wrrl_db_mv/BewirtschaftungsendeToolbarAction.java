...
public class BewirtschaftungsendeToolbarAction extends AbstractNewObjectToolbarAction {
    ...
    public String getTableName() {
        return "bewirtschaftungsende";
    }

    @Override
    public String getTooltipString() {
        return "neues Bewirtschaftungsende anlegen";
    }
}
