 ...
 */
public abstract class AbstractLegendPrintingTemplate extends AbstractPrintingInscriber {
    ...
    public HashMap<String, String> getValues() {
        ...
        URL url = AbstractLegendPrintingTemplate.class.getResource("/de/cismet/cismap/commons/gui/printing/"
                        + imageName + ".jpg");

        if (url == null) {
            url = AbstractLegendPrintingTemplate.class.getResource("/" + imageName + ".jpg");
...
//                hm.put("legend", ConversionUtils.image2String(rescaleImage(legend))); // NOI18N
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(
                AbstractLegendPrintingTemplate.class,
                "AbstractLegendPrintingTemplate.jLabel1.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(
                AbstractLegendPrintingTemplate.class,
                "AbstractLegendPrintingTemplate.jLabel2.text")); // NOI18N
